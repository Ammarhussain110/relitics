...
app.get('/api/cities/:countryCode/:isoCode', (req, res) => {
  const cities = City.getCitiesOfState(req.params.countryCode, req.params.countryCode)
  res.send({ success: true, cities: cities.length })
})
